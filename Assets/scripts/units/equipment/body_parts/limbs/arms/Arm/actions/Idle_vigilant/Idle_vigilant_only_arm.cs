...
public class Idle_vigilant_only_arm: Action_of_arm {
    ...
    public static Idle_vigilant_only_arm create(
        ...
        Idle_vigilant_only_arm action = 
            (Idle_vigilant_only_arm)object_pool.get(typeof(Idle_vigilant_only_arm));
    ...
    public override void update() {
        ...
        arm.shoulder.set_target_rotation(
            arm.shoulder.desired_idle_rotation * direction_to_target
        );
        
        arm.upper_arm.set_target_rotation(
            arm.upper_arm.desired_idle_rotation * direction_to_target
        );
        
        arm.forearm.set_target_rotation(
            arm.forearm.desired_idle_rotation * direction_to_target
        );
        
        arm.hand.set_target_rotation(
