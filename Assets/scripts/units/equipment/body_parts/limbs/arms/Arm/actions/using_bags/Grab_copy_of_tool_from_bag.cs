...
public class Grab_copy_of_tool_from_bag: Grab_tool_from_bag {

    protected IExpendable_equipment expendable_equipment;
    
    public static Grab_copy_of_tool_from_bag create(
        Arm in_arm,
        Baggage in_bag, 
        Tool in_tool,
        IExpendable_equipment expendable_equipment
    ) {
        var action = (Grab_copy_of_tool_from_bag)object_pool.get(typeof(Grab_copy_of_tool_from_bag));
    ...
    public Grab_copy_of_tool_from_bag() {
