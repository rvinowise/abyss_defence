...
public class Grab_tool_from_bag: Action_of_arm {
    ...
    public static Grab_tool_from_bag create(
        Arm in_arm,
        Baggage in_bag, Tool in_tool
    ) {
        var action = (Grab_tool_from_bag)object_pool.get(typeof(Grab_tool_from_bag));
