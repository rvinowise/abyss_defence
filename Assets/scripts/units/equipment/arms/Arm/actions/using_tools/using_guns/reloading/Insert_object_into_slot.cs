...
public class Insert_object_into_slot: Action_parent {
    ...
    public static parts.actions.Action create(
        ...
        var action = (Insert_object_into_slot)pool.get(typeof(Insert_object_into_slot), in_parent);
    ...
    private void init_child_actions() {
        current_child_action = Arm_reach_transform.create(
