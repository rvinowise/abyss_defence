Shader "Universal Render Pipeline/2D/Sprite-for-masking" 
//based on Universal Render Pipeline/2D/Sprite-Lit-Default
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 CombinedShapeLightFragment(Varyings i) : SV_Target
            {
                ...
                return CombinedShapeLightShared(main, float4(1,1,1,1), i.lightingUV);
            }
            ENDHLSL
        }
